                    ...
                    <Col sm="6">
                      ...
                      >
                        ...
                        >
                          ...
                          <span className="d-block d-sm-none">
                            <i className="wav-icons icon-gift-2" />
                          </span>
                        </Button>
                        <Button
                          color="primary"
                        ...
                        >
                          ...
                          <span className="d-block d-sm-none">
                            <i className="wav-icons icon-tap-02" />
                          </span>
                        </Button>
                      </ButtonGroup>
                    </Col>
            ...
            <Col className="text-right" lg="4">
              <Card className="card-chart">
                <CardHeader>
                  ...
                  <CardTitle tag="h3">
                    <i className="wav-icons icon-bell-55 text-primary" />{" "}
                    763,215
                  </CardTitle>
                </CardHeader>
                <CardBody>
            ...
            <Col className="text-right" lg="4">
              <Card className="card-chart">
                <CardHeader>
                  ...
                  <CardTitle tag="h3">
                    <i className="wav-icons icon-delivery-fast text-info" />{" "}
                    3,500€
                  </CardTitle>
                </CardHeader>
                <CardBody>
            ...
            <Col className="text-right" lg="4">
              <Card className="card-chart">
                <CardHeader>
                  ...
                  <CardTitle tag="h3">
                    <i className="wav-icons icon-send text-success" /> 12,100K
                  </CardTitle>
                </CardHeader>
                <CardBody>
                  <div className="chart-area">
                ...
                <CardHeader className="text-right">
                  ...
                  <UncontrolledDropdown className="float-left">
                    <DropdownToggle
                      ...
                      id="dropdownMenuLink"
                    >
                      <i className="wav-icons icon-settings-gear-63" />
                    </DropdownToggle>
                        ...
                        <tr>
                          ...
                          <td className="td-actions">
                            <Button
                              ...
                              type="button"
                            >
                              <i className="wav-icons icon-settings" />
                            </Button>
                            <UncontrolledTooltip
                              delay={0}
